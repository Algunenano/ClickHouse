...
namespace Setting
{
    extern SettingsBool enable_url_encoding;
    extern SettingsBool engine_url_skip_empty_files;
    extern SettingsUInt64 glob_expansion_max_elements;
    extern SettingsUInt64 max_http_get_redirects;
    ...
    extern SettingsBool schema_inference_cache_require_modification_time_for_url;
    extern SettingsSchemaInferenceMode schema_inference_mode;
    extern SettingsBool schema_inference_use_cache_for_url;
