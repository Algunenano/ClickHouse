...
namespace Setting
{
    extern SettingsFloat backup_restore_keeper_fault_injection_probability;
    extern SettingsUInt64 backup_restore_batch_size_for_keeper_multi;
    extern SettingsUInt64 backup_restore_batch_size_for_keeper_multiread;
    extern SettingsUInt64 backup_restore_failure_after_host_disconnected_for_seconds;
    extern SettingsUInt64 backup_restore_finish_timeout_after_error_sec;
    extern SettingsUInt64 backup_restore_keeper_fault_injection_seed;
    extern SettingsUInt64 backup_restore_keeper_max_retries;
    extern SettingsUInt64 backup_restore_keeper_max_retries_while_handling_error;
    extern SettingsUInt64 backup_restore_keeper_max_retries_while_initializing;
    extern SettingsUInt64 backup_restore_keeper_retry_initial_backoff_ms;
    extern SettingsUInt64 backup_restore_keeper_retry_max_backoff_ms;
    extern SettingsUInt64 backup_restore_keeper_value_max_size;
}
