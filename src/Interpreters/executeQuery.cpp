...
namespace Setting
{
    ...
    extern SettingsBool allow_experimental_kusto_dialect;
    extern SettingsBool allow_experimental_prql_dialect;
    ...
    extern SettingsBool enable_reads_from_query_cache;
    extern SettingsBool enable_writes_to_query_cache;
    extern SettingsSetOperationMode except_default_mode;
    extern SettingsOverflowModeGroupBy group_by_overflow_mode;
    extern SettingsBool implicit_transaction;
    extern SettingsSetOperationMode intersect_default_mode;
    extern SettingsOverflowMode join_overflow_mode;
    extern SettingsString log_comment;
    extern SettingsBool log_formatted_queries;
    ...
    extern SettingsFloat log_queries_probability;
    extern SettingsBool log_query_settings;
    ...
    extern SettingsBool query_cache_compress_entries;
    extern SettingsUInt64 query_cache_max_entries;
    extern SettingsUInt64 query_cache_max_size_in_bytes;
    extern SettingsMilliseconds query_cache_min_query_duration;
    extern SettingsUInt64 query_cache_min_query_runs;
    extern SettingsQueryResultCacheNondeterministicFunctionHandling query_cache_nondeterministic_function_handling;
    extern SettingsBool query_cache_share_between_users;
    extern SettingsBool query_cache_squash_partial_results;
    extern SettingsQueryResultCacheSystemTableHandling query_cache_system_table_handling;
    extern SettingsSeconds query_cache_ttl;
    extern SettingsInt64 query_metric_log_interval;
    ...
    extern SettingsBool use_query_cache;
    ...
    extern SettingsBool enforce_strict_identifier_format;
    extern SettingsMap http_response_headers;
