...
#define INITIALIZE_SETTING_EXTERN(TYPE, NAME, DEFAULT, DESCRIPTION, FLAGS) \
    S3RequestSettings##TYPE NAME = { &S3RequestSettingsImpl ::data_##TYPE , &S3RequestSettingsImpl :: position_##NAME };
    ...
    if (!(*this)[S3RequestSetting::strict_upload_part_size])
    {
        if (!(*this)[S3RequestSetting::min_upload_part_size])
            throw Exception(
                ...
                ReadableSize((*this)[S3RequestSetting::min_upload_part_size]));
        ...
        if ((*this)[S3RequestSetting::max_upload_part_size] < (*this)[S3RequestSetting::min_upload_part_size])
            throw Exception(
                ...
                ReadableSize((*this)[S3RequestSetting::max_upload_part_size]), ReadableSize((*this)[S3RequestSetting::min_upload_part_size]));
        ...
        if (common::mulOverflow((*this)[S3RequestSetting::max_upload_part_size].value, (*this)[S3RequestSetting::upload_part_size_multiply_factor].value, maybe_overflow))
            throw Exception(
                            ...
                            (*this)[S3RequestSetting::upload_part_size_multiply_factor].value, ReadableSize((*this)[S3RequestSetting::max_upload_part_size]));
    }
